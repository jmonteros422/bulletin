			...
			fixFPD: function(issueID) {
				...
				this.ajax('wordfence_checkFalconHtaccess', {}, function(res) {
					if (res.ok) {
						...
						self.colorbox("400px", title, 'You are using an Nginx web server and using a FastCGI processor like PHP5-FPM. You will need to manually modify your php5.ini to disable <em>display_error</em>');
					} else if (res.err) {
