...
<head>
	...
	<script src="<?php bloginfo('template_url'); ?>/javascripts/vendor/jquery.textfill.js"></script>
	<script src="<?php bloginfo('template_url'); ?>/javascripts/vendor/jquery.textfill.min.js"></script>
