...
function wp_raise_memory_limit( $context = 'admin' ) {
	...
	switch ( $context ) {
		case 'admin':
			 ...
			 * (256 megabytes of memory) or the original `memory_limit` php5.ini value if
			 * this is higher.
			 *
			 * @since 3.0.0
		...
		case 'image':
			 ...
			 *                                   php5.ini `memory_limit`, whichever is higher.
		...
		default:
			 ...
			 *
			 * @param int|string $filtered_limit Maximum memory limit to allocate for images.
			 *                                   Default '256M' or the original php5.ini `memory_limit`,
