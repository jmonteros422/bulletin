...
function wp_import_handle_upload() {
	if ( ! isset( $_FILES['import'] ) ) {
		return array(
			'error' => __( 'File is empty. Please upload something more substantial. This error could also be caused by uploads being disabled in your php5.ini or by post_max_size being defined as smaller than upload_max_filesize in php5.ini.' )
		);
	}
