...
function _wp_handle_upload( &$file, $overrides, $time, $action ) {
	...
	if ( isset( $overrides['upload_error_strings'] ) ) {
		...
		$upload_error_strings = array(
			false,
			__( 'The uploaded file exceeds the upload_max_filesize directive in php5.ini.' ),
	...
	if ( $test_size && ! ( $test_file_size > 0 ) ) {
		if ( is_multisite() ) {
			...
			$error_msg = __( 'File is empty. Please upload something more substantial. This error could also be caused by uploads being disabled in your php5.ini or by post_max_size being defined as smaller than upload_max_filesize in php5.ini.' );
		}
